...
<div class="container">
      ...
      <div class="row">
          ...
          <div class="col-xs-6"> 
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse1">Provenance <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse1">
            <div class="col-xs-12 text-justify">
              <div class="form-group">
          ...
          <div class="col-xs-6">
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse2">Place of composition <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse2">
            <div class="col-xs-12 text-justify">
              <div class="form-group">
          ...
          <div class="row">
          <div class="col-xs-6">
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse3">Shelfmark <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse3">
            <div class="col-xs-12 text-justify">
              <div class="form-group">
          ...
          */ ?>
          ...
          <div class="col-xs-6">
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse4">Source <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse4">
            <div class="col-xs-12 text-justify">
              <div class="form-group">
                <label for="source" class="control-label col-xs-12">Source</label>
                <div class="col-xs-12">
          ...
          <div class="row">
          <div class="col-xs-6">
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse5">IsPartOf <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse5">
            <div class="col-xs-12 text-justify">
              <div class="form-group" style="display: none;">
          ...
          <div class="col-xs-6">
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse6">hasPart <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse6">
            <div class="col-xs-12 text-justify">
              <div class="form-group" style="display: none;">
          ...
          <div class="row">
          <div class="col-xs-6">
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse7">Divisions of the text <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse7">
            <div class="col-xs-12 text-justify">
              <div class="form-group">
          ...
          <div class="col-xs-6">
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse8">Language <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse8">
            <div class="col-xs-12 text-justify">
              <div class="form-group" style="display: none;">
          ...
          <div class="row">
          <div class="col-xs-6">
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse9">Metadata source code <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse9">
            <div class="col-xs-12 text-justify">
              <div class="form-group">
          ...
          <div class="col-xs-6">
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse10">OCR <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse10">
            <div class="col-xs-12 text-justify">
              <div class="form-group">
          ...
          <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse11">Notes <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse11">
            <div class="col-xs-12">
              <div class="form-group">
          ...
          <input type="hidden" class="hide" name="submitted" value="true">
      	  ...
      	  <h3 class="form-legend collapse-form-element"><a class="accordion-toggle" data-toggle="collapse" href="#collapse12">Alternative title(s) <small>(optional)</small></a></h3>
          <section class="form-group collapse" id="collapse12">
            <div class="col-xs-12 text-justify">
              <div class="form-group" style="display: none;">
